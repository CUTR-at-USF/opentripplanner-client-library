...
class BikeRentalApiUnitTest {
    ...
    fun testBikeRentalApi() {
        val bikeRentalApi =
            BikeRentalApi("https://raw.githubusercontent.com/CUTR-at-USF/opentripplanner-client-library/main/otp-client-library/src/jvmTest/resources/tampa/bike_rental.json")
